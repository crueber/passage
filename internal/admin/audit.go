...
const (
	...
	AuditActionAppGroupCreate       = "app.group.create"
	AuditActionAppGroupUpdate       = "app.group.update"
	AuditActionAppGroupDelete       = "app.group.delete"
	AuditActionAppRoleCreate        = "app.role.create"
	AuditActionAppRoleUpdate        = "app.role.update"
	AuditActionAppRoleDelete        = "app.role.delete"
	AuditActionAppAssignmentsUpdate = "app.assignments.update"
